...
Widget BuildFavItem(FavoritesModel? model, index, context) {
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    //
                    Text(
                      model.data!.data2[index].product!.name,
                    ...
                    Row(
                      children: [
                        //
                        Text(
                          '${model.data!.data2[index].product!.price}',
                        ...
                        if (model.data!.data2[index].product!.discount != 0)
                          //
                          Text(
                            '${model.data!.data2[index].product!.oldPrice}',
                            style: const TextStyle(
                                color: Colors.grey,
                        ...
                        CircleAvatar(
                          ...
                          backgroundColor: cubit.favoriteProductsMap[
                                      model.data!.data2[index].product!.id] ==
                                  true
                              ? Colors.red
                              : defaultColor,
                          child: IconButton(
